...
class SayCommand extends Command {
  ...
  run(message, args) {
    ...
    if (!channel) {
      return message.reply('you need to be in a voice channel first master!');
    }

    if (args.length < 1) {
      return message.reply('you need to tell me what to say, stupid');
    }
    ...
    if (channel.full) {
      return message.reply('Your voice channel is full. LET ME IN!');
    }
